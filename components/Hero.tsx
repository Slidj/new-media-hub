  ...
  return (
    <div className="relative h-screen w-full text-white overflow-hidden bg-black">
      ...
      <div className="relative z-20 h-full flex flex-col justify-end pb-[20vh] md:pb-[28vh] px-4 md:px-12 w-full max-w-full">
        ...
        <div className="mb-6 md:mb-8">
            {movie.logoUrl ? (
                <img 
                    src={movie.logoUrl} 
                    alt={movie.title} 
                    className="w-full max-w-[300px] md:max-w-[500px] max-h-[120px] md:max-h-[240px] object-contain drop-shadow-[0_15px_15px_rgba(0,0,0,0.9)]"
                />
            ) : (
        ...
        {/* Minimal Info Row */}
        <div className="flex items-center gap-4 text-sm md:text-xl font-bold mb-6 md:mb-8 drop-shadow-lg bg-black/10 backdrop-blur-[2px] w-fit px-3 py-1 rounded-sm border border-white/5">
        ...
        <div className="flex items-center gap-4">
          <button 
            onClick={onPlay}
            className="flex items-center justify-center gap-2 px-6 md:px-8 py-2 md:py-3 bg-white text-black font-bold rounded-[4px] hover:bg-white/80 transition-all active:scale-95 shadow-2xl"
          >
          ...
          <button 
            onClick={onMoreInfo}
            className="flex items-center justify-center gap-2 px-6 md:px-8 py-2 md:py-3 bg-gray-500/40 text-white font-bold rounded-[4px] hover:bg-gray-500/60 transition-all active:scale-95 backdrop-blur-md border border-gray-400/20 shadow-2xl"
          >
