...
export const BottomNav: React.FC<BottomNavProps> = ({ lang, activeTab, onTabChange, onMoreClick }) => {
  ...
  return (
    ...
    <div className="md:hidden z-50 transition-all duration-500 fixed bottom-0 left-0 w-full pb-safe safe-area-bottom shadow-[0_-5px_20px_rgba(0,0,0,0.5)] bg-black border-t border-[#222] flex justify-between items-center">
      ...
      >
        <MonitorPlay className="w-6 h-6" strokeWidth={2} />
