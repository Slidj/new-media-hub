...
export const translations = {
  en: {
    ...
    supportDesc: "Describe your issue or suggestion. You can send one message per day.",
    supportPlaceholder: "Write your message here...",
    supportSend: "Send Message",
    supportSuccess: "Message sent successfully!",
    supportLimit: "You can only send one message per 24 hours.",
    supportEmpty: "Message cannot be empty.",
  ...
  uk: {
    ...
    supportDesc: "Опишіть вашу проблему або пропозицію. Ви можете надіслати одне повідомлення на добу.",
    supportPlaceholder: "Напишіть ваше повідомлення тут...",
    supportSend: "Надіслати",
    supportSuccess: "Повідомлення успішно надіслано!",
    supportLimit: "Ви можете надсилати лише одне повідомлення на добу.",
    supportEmpty: "Повідомлення не може бути порожнім.",
  ...
  ru: {
    ...
    supportDesc: "Опишите вашу проблему или предложение. Вы можете отправить одно сообщение в сутки.",
    supportPlaceholder: "Напишите ваше сообщение здесь...",
    supportSend: "Отправить",
    supportSuccess: "Сообщение успешно отправлено!",
    supportLimit: "Вы можете отправлять только одно сообщение в сутки.",
    supportEmpty: "Сообщение не может быть пустым.",
